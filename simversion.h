...
#define EX_SAVE_MINOR		7

// Do not forget to increment the save game versions in settings_stats.cc when changing this

#define MAKEOBJ_VERSION "60.02"
// Transparency and new factories(60.0), railcar_tab and extend_veh_constraint(60.02). NOTE: standard now 60.2
