...
script_api::void_t simple_heap_insert(simple_heap_t *heap, sint32 weight, sint32 value)
{
...
script_api::void_t way_builder_set_build_types(way_builder_t *bob, const way_desc_t *way)
{
	if (way) {
