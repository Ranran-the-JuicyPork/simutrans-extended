...
public:
	...
	static PIXVAL gui_color_heading_text;                 //@< (EX unique) Text color of headings(heading2-) whose text color is not specified.
	static PIXVAL gui_color_heading_text_highlight;       //@< (EX unique) Text color of heading1 whose text color is not specified
