...
//		padding = max(padding, display_proportional_clip_rgb(left + VEHICLE_BAR_HEIGHT * 2 + 3, top, translator::translate(bar_color_helptexts[i]), ALIGN_LEFT, SYSCOL_TEXT_WEAK, true));
//
//		//;
//
//		top += LINESPACE;
...
//	left += padding + VEHICLE_BAR_HEIGHT * 2 + 3 + D_H_SPACE;
	...
	top += LINESPACE;
	top += LINESPACE;
	display_veh_form_wh_clip_rgb(left, top + padding_y, VEHICLE_BAR_HEIGHT*2, VEHICLE_BAR_HEIGHT, COL_SAFETY, true, false, vehicle_desc_t::fixed_coupling_prev, 0, false);
